...
| Species review queue and individual recommendations/decisions — review screen | Review routes | Queue with image/provenance/confidence, opt-in recommendation, confirm/choose/reject, retry/error state | Domain/API tests | IMPLEMENTED |
