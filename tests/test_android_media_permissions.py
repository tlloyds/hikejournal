...
def test_android_uses_picker_without_broad_media_permissions() -> None:
    ...
    sync = Path("android/app/src/main/java/com/hikejournal/app/data/FieldSync.kt").read_text()
    assert "MediaStore.setRequireOriginal" in sync
    assert "ACCESS_MEDIA_LOCATION" in sync
