...
class HikeJournalRepository:
    ...
    def upsert_hike_location(self, name: str, **values: Any) -> dict[str, Any] | None:
        ...
        payload = {
            ...
            "source_slug": values.get("source_slug"),
            "state": values.get("state"),
            "region": values.get("region"),
            "county": values.get("county"),
            "manager_name": values.get("manager_name"),
            "manager_type": values.get("manager_type"),
            "lat": values.get("lat"),
            "lng": values.get("lng"),
            ...
            payloads.append(
                {
                    ...
                    "source_slug": location.get("source_slug"),
                    "state": str(location.get("state") or "").upper() or None,
                    "region": location.get("region"),
                    "county": location.get("county"),
                    "manager_name": location.get("manager_name"),
                    "manager_type": location.get("manager_type"),
